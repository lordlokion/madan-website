    ...
    <div class="px-16 bg-white">
        <div class="container flex flex-col items-start mx-auto lg:items-center">
            ...
            <h2 class="relative flex items-start justify-start w-full max-w-3xl text-5xl font-bold lg:justify-center">
                ...
                <span class=""><svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="absolute right-0 hidden w-12 h-12 -mt-2 -mr-16 text-green-500 lg:inline-block" viewBox="0 0 975.036 975.036">
            ...
            See what our clients are saying!</h2>
            ...
            <div class="items-center justify-center w-full mt-12 mb-4 lg:flex">
                <div class="flex flex-col items-start justify-start w-full h-auto mb-12 lg:w-1/3 lg:mb-0">
                    <div class="flex items-center justify-center">
                        ...
                        <div class="flex flex-col items-start justify-center">
                            ...
                            <p class="text-gray-600">Rajesh Printing Solutions</p>
                        </div>
                    </div>
                    <blockquote class="mt-8 text-lg text-gray-500">"We've been relying on Madan Engg Works for our die punching needs, and the precision and efficiency of their machines are unmatched. Proud to be associated with such a reliable Indian company!"</blockquote>
                </div>
                <div class="flex flex-col items-start justify-start w-full h-auto px-0 mx-0 mb-12 border-l border-r border-transparent lg:w-1/3 lg:mb-0 lg:px-8 lg:mx-8 lg:border-gray-200">
                    <div class="flex items-center justify-center">
                        ...
                        <div class="flex flex-col items-start justify-center">
                            <h4 class="font-bold text-gray-800">Deepa Singh</h4>
                            <p class="text-gray-600">Perfet Papers Ltd.</p>
                        </div>
                    </div>
                    <blockquote class="mt-8 text-lg text-gray-500">" Exceptional quality and robust performance. Truly a game-changer for our business!
                        Thanks for making such a great product. I would highly recommend this to anyone."</blockquote>
                </div>
                <div class="flex flex-col items-start justify-start w-full h-auto lg:w-1/3">
                    <div class="flex items-center justify-center">
                        ...
                        <div class="flex flex-col items-start justify-center">
                            <h4 class="font-bold text-gray-800">Anuj Verma</h4>
                            <p class="text-gray-600"> Precision Packaging Ltd.</p>
                        </div>
                    </div>
                    <blockquote class="mt-8 text-lg text-gray-500">"The precision of Machines' paper cutting machines has elevated the standards of our print production. Our clients notice the difference, and so do we. Thank you for making such reliable equipment right here in India."</blockquote>
                </div>
            </div>
        </div>
    </div>
