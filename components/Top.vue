<template>
  <section class="hidden lg:block m-auto max-w-6xl">
    <nav class="relative px-6 lg:py-6 flex flex-wrap justify-between items-center">
      ...
      <ul
        class="hidden md:flex md:mx-auto md:flex md:items-center md:w-auto md:space-x-6"
      >
        <li>
          <nuxt-link to="/" class="text-sm text-gray-400 hover:text-gray-500">Home</nuxt-link>
        </li>
        <li>
          <nuxt-link to="/pro" class="text-sm text-gray-400 hover:text-gray-500">Products</nuxt-link>
        </li>
        <li>
          <nuxt-link to="/about" class="text-sm text-gray-400 hover:text-gray-500">About</nuxt-link>
        </li>
        <li>
          <nuxt-link to="/testimonials" class="text-sm text-gray-400 hover:text-gray-500">Testimonials</nuxt-link>
        </li>
      </ul>

      <a
        class="hidden lg:inline-block py-2 px-6 bg-white hover:bg-gray-50 text-sm text-green-600 font-bold rounded-l-xl rounded-t-xl transition duration-200"
        href="https://wa.me/981431591?text=Hello%20there!"
      >
        <svg
      ...
      <a
        class="block md:hidden py-2 px-6 bg-white hover:bg-gray-50 text-sm text-green-600 font-bold rounded-l-xl rounded-t-xl transition duration-200 mt-4"
        href="https://wa.me/981431591?text=Hello%20there!"
      >
        <img
